    ...
    <div>
      ...
      <section className="bg-white section-padding">
        <div className="container-main px-6 lg:px-20">
          {/* 5-column grid on large screens: form takes 3, the contact-details
              sidebar takes 2 (see ContactSidebarBlock.tsx's lg:col-span-2).
              When there's no sidebar block yet, collapse to a single,
              width-capped column so the form isn't stranded at 3/5 width
              with empty space beside it, nor left full-bleed across the
              page -- the same guard About.tsx uses for its photo/bio grid. */}
          <div
            className={
              sidebarBlock
          ...
          >
            <div className={sidebarBlock ? 'lg:col-span-3' : ''}>
