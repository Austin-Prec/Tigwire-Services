...
export default function PricingNotesBlock({ content }: PricingNotesBlockProps) {
  ...
  return (
    <section className="bg-white pb-16 md:pb-24">
      ...
      >
        <div className="rounded-xl p-6 bg-gray-50 border border-gray-200 transition-all duration-300 hover:border-transparent hover:shadow-[0_20px_40px_-16px_rgba(21,42,74,0.2)]">
          {content.heading && (
