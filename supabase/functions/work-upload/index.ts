...
// Near-identical to articles-upload/index.ts, adapted for the work-images
// bucket. See that function for the original version this was copied from.
...
// GIF is deliberately excluded here (unlike articles-upload, which allows
// it for blog post images) -- a before/after comparison photo is always a
// static shot, so there's no sensible use for an animated image in this
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    console.error("work-upload function error:", err);
